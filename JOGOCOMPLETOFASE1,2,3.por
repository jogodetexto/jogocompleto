...
escreva("FFFFFFFFFFF  AAAAAAA                   AAAAAAASSSSSSSSSSSSSSS   EEEEEEEEEEEEEEEEEEEEEE     111111111111\n")
	...
	funcao dialogoSozinhoAposCompra(){
			escreva("(Gustavo)-Muito obrigado, moço!")u.aguarde(1000) escreva(" Agora \"tô\" com um cagaço de entrar nessa p#$%@ mas tudo bem...\n")u.aguarde(2000)
					...
					escreva("(Zanette)-Ficamos com medo pela demora e viemos te procurar.")u.aguarde(1500) escreva(" Viemos buscar juntos, vai ser da hora.\n")u.aguarde(2000)
...
escreva("FFFFFFFFFFF  AAAAAAA                   AAAAAAASSSSSSSSSSSSSSS   EEEEEEEEEEEEEEEEEEEEEE     22222222222222222222\n")
	...
	u.aguarde(5000)
	limpa()
	escreva("(Narração)-Após uma longa caminhada nessa floresta misteriosa, os amigos acabaram achando 2 caminhos alterantivos, um para esquerda e outro para direita\n")
	u.aguarde(5000)
	limpa()
	...
	escreva("(Narração)- E entao os amigos se separam, eles estavam confiantes e tinham certeza que iam achar a bola o mais rapido possivel")
	u.aguarde(5000)
	limpa()
	escreva("*VISAO DO LUIGU E JOAO ANTONIO*\n")
	escreva("---------------------------------\n")
	u.aguarde(5000)
	escreva("(João Antonio)-Cara eu tô me cagando muito mds\n")
	u.aguarde(5000)
...
limpa()
	...
	escreva("(Narração)-Então os dois guerreiros infelizmente acharam o monstro Mauricio e agora?? O que eles irão fazer?\n")
	u.aguarde(5000)
	escreva("VOCÊS FOGEM???!!!?(S/N): ")
	leia(respostaa)
		se(respostaa == "S" ou respostaa =="s"){
			...
			limpa()
			escreva("Narração)- Eles fogem do mesmo jeito, eles não tem coragem de lutar porque eles sao cagões...\n")
			u.aguarde(5000)
			limpa()
		}

		escreva("(Narração)-Luigu e João Antonio fogem freneticamente por muito tempo..\n")
		u.aguarde(5000)
		limpa()
		escreva("(João Antonio)-MEO DEUS DO CÉU LUIGU JÁ ERA A GENTE VAI MORRER MEO DEU CORRE!!!\n")
		u.aguarde(2000)
		...
		escreva(".\n")
		u.aguarde(2000)
		escreva("(Luigu)-JOÃO CADE VOCE MANO!!!!!\n")
		u.aguarde(5000)
		escreva("(João Antonio)-LUIGU!!!! ME AJUDA EU TO AQUI!!!\n")
		u.aguarde(2000)
		escreva("(Luigu)-João!!! COMO VOCE FOI PARAR DENTRO DESSE BURACO CARA!!\n")
		u.aguarde(2000)
		escreva("(João Antonio)-EU NAO SEI MANO! ME AJUDA LOGO!! ME TIRA DAQUII AAAA\n")
		u.aguarde(2000)
		escreva("(Luigu)-o bixo ta vindo cara, se eu te salvar eu vou morrer tambem..\n")
		u.aguarde(2000)
		escreva("(João Antonio)-Por favor Luigu...\n")
		u.aguarde(2000)
		escreva("*SALVAR JOÃO ANTONIO OU NAO???*(S/N): ")
		leia(save)
		limpa()
		...
		u.aguarde(5000)
				...
				se(save == "S" ou save == "s"){
					escreva("(Luigu)-VEM LOGO JOÃO ANTONIO EU NAO VOU TE DEIXAR SOSINHO\n")
					u.aguarde(5000)
					escreva("(João Antonio)-TAMO JUNDO LUIGAO CARA, AGORA VAMO CORRER LOGO\n")
					u.aguarde(5000)
					limpa()
					savejoao()
				}senao{
					escreva("(Luigu)-Desculpa João..., vou ter que ir, se nao poso morrer junto\n")
					u.aguarde(5000)
					escreva("(João Antonio)- NAO, NAO LUIGU NAO !!!!\n")
					u.aguarde(5000)
					limpa()
					naosavejoao()
				}
	...
	funcao savejoao()
	{
		...
		escreva("(Luigu)-João, calma, sera que realmente o melhor é fugir e não lutar??\n")
		u.aguarde(5000)
...
limpa()
	...
	escreva("FFFFFFFFFFFFFFFFFFFFFF      AAA                 SSSSSSSSSSSSSSS EEEEEEEEEEEEEEEEEEEEEE      333333333333333   \n")
		...
		escreva("(Jack)-Primeiro, meu nome é Jack. Segundo, um soco não não fiunciona contar mim\n") u.aguarde(3000)
		...
		escreva("(Gustavo)-Boa!!!\n")u.aguarde(3000)
		escreva("(Zanette)-Eu manjo das apostas, tinha que me ver no poker.\n")u.aguarde(3000)
