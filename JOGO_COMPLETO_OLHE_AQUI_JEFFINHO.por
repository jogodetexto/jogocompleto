...
escreva("---------------------------------\n")
u.aguarde(1000)
escreva("(João Antonio) - Cara, eu to com muito medo  mds.\n")
u.aguarde(3000)
...
u.aguarde(2000)
	...
	u.aguarde(3500)limpa()
	escreva("(Narrador)- Seus amigos continuam suas vidas e constroem uma linda historia cada um, graças ao Luigu\n")
	u.aguarde(3500)
...
escreva("FFFFFFFFFFF           IIIIIIIIIIMMMMMMMM               MMMMMMMM\n")
 ...
 se(VoltarOuFicar == 2){
	...
	u.aguarde(2000)
	escreva("(Lugiu)- EITA K@RL@H* QUE ISSSO!\n")
	u.aguarde(2000)
